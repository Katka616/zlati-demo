...
export const WALKTHROUGH_STEPS: Record<string, { sk: WalkthroughStep[]; cz: WalkthroughStep[] }> = {
  ...
  '/dispatch/demo': {
    ...
    cz: [
      ...
      { target: 'job-status-chip', title: 'Průběh zakázky', description: 'Přehled fází zakázky:\n\n1. Příjezd — navigujte se na místo\n2. Diagnostika — vyfoťte problém\n3. Odhad — zadejte materiál a hodiny\n4. Oprava — pracujte na opravě\n5. Protokol — vyplňte protokol s podpisem klienta\n6. Faktura — systém vygeneruje fakturu automaticky', position: 'bottom' },
