...
export const WALKTHROUGH_STEPS: Record<string, { sk: WalkthroughStep[]; cz: WalkthroughStep[] }> = {
  ...
  '/dispatch/demo': {
    ...
    cz: [
      ...
      { target: 'job-info-sections', title: 'Detaily a diagnostika', description: 'Zde najdete:\n\n• Detaily zakázky — kategorie, pojišťovna, číslo\n• Informace od klienta — popis problému z diagnostického formuláře\n• AI Diagnostika — automatický návrh opravy, postupu a materiálu\n• Dokumenty — protokoly a fotky\n\nKliknutím na sekci ji rozbalíte nebo sbalíte.', position: 'bottom' },
      { target: 'walkthrough-estimate-info', title: 'Cenový odhad', description: 'Po diagnostice zadáte odhad:\n• Počet hodin práce\n• Km na místo (GPS měření)\n• Materiál — vyberete z katalogu nebo přidáte vlastní\n\nAplikace automaticky spočítá cenu podle vašich sazeb.\n\nPokud klient musí doplatit nad rámec pojistky, dostane SMS s odkazem na portál, kde doplatek schválí nebo odmítne — přímo na svém mobilu.', position: 'bottom' },
      { target: 'walkthrough-protocol-info', title: 'Protokol a podpis klienta', description: 'Po dokončení práce vyplníte protokol:\n• Popis provedené práce\n• Použitý materiál (předvyplněný z odhadu)\n• Fotky před a po opravě\n\nKlient dostane SMS s odkazem na portál, kde si protokol přečte a podepíše elektronicky na svém mobilu. Nemusíte tisknout papíry ani čekat na podpis na místě.', position: 'bottom' },
      { target: 'walkthrough-invoice-info', title: 'Fakturace', description: 'Po vyúčtování máte 2 možnosti:\n\n• Vygenerovat fakturu — aplikace vytvoří fakturu automaticky z vašich sazeb a odpracovaných hodin. Zadáte vlastní variabilní symbol. K faktuře vám pošleme i soubor pro účetní (ISDOC).\n• Nahrát vlastní — pokud fakturujete přes vlastní systém, jednoduše nahrajete PDF\n\nÚhrada od nás standardně do 14 dnů.', position: 'bottom' },
      { target: 'job-action-button', title: 'Hlavní tlačítko', description: 'Zlaté tlačítko dole vždy ukazuje další krok. Stačí kliknout a zakázka se posune dál.\n\nPokud čekáte na schválení od operátora nebo klienta, tlačítko pulzuje a informuje vás o stavu.', position: 'top' },
    ],
  },
